  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 overflow-x-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center pt-32 pb-24 text-center z-10">
        ...
        >
          <div className="inline-block text-2xl md:text-4xl font-extrabold leading-tight">
            ...
            >
              Beautiful, <AnimatedKeywords className="inline" words={["Smart"]} /> Resumes in Minutes
            </span>
          </div>
        </motion.div>
        <motion.p
        ...
        >
          ...
          >
            ...
            <span className="inline-block ml-3 align-middle">
              ...
              >
                <path d="M7 14h14m0 0l-5-5m5 5l-5 5" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
              </motion.svg>
            </span>
          </Button>
        </motion.div>
        ...
        <div className="absolute left-0 right-0 top-0 pointer-events-none z-0">
          <svg className="mx-auto" width="100%" height="120" viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill="url(#paint0_linear)" fillOpacity="0.2" d="M0,64L48,74.7C96,85,192,107,288,117.3C384,128,480,128,576,112C672,96,768,64,864,69.3C960,75,1056,117,1152,133.3C1248,149,1344,139,1392,133.3L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z" />
            <defs>
      ...
      <section id="testimonials" className="max-w-7xl mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              <img src={t.avatar} alt={t.name} className="w-16 h-16 rounded-full mb-4 shadow-md object-cover" />
      ...
      <section className="py-24 px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 drop-shadow-lg">Ready to Create Your Resume?</h2>
          <p className="mb-8 text-lg md:text-xl opacity-90">Join thousands of job seekers who have landed their dream jobs with ResumeAI.</p>
          <Button 
            size="lg"
            onClick={() => window.location.href = '/api/login'}
          ...
          <div className="absolute -top-10 -right-10 opacity-30 pointer-events-none">
            <svg width="120" height="120" viewBox="0 0 120 120" fill="none"><circle cx="60" cy="60" r="60" fill="#fff" /></svg>
          </div>
          <div className="absolute -bottom-10 -left-10 opacity-20 pointer-events-none">
            <svg width="120" height="120" viewBox="0 0 120 120" fill="none"><rect width="120" height="120" rx="60" fill="#fff" /></svg>
          </div>
        </motion.div>
      </section>
    </div>
