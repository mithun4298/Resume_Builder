...
export const CreativeTemplatePreview = ({ resumeData }: { resumeData: any }) => {
  const getSectionTitleStyles = () => "text-lg font-semibold text-purple-600 mb-2 bg-purple-100 px-2 py-1 rounded";
  const getSkillTagStyles = () => "px-2 py-1 bg-purple-100 text-purple-800 text-xs font-medium rounded";
  const getExperienceBorderStyles = () => "border-l-4 border-purple-400 pl-4";

  return (
    <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 space-y-4 max-h-96 overflow-y-auto">
      <div className="text-center bg-purple-600 text-white p-4 rounded-t-lg -m-6 mb-4">
        <h1 className="text-2xl font-bold text-white">
          {resumeData.personalInfo.firstName} {resumeData.personalInfo.lastName}
        </h1>
        <div className="flex flex-wrap justify-center gap-4 mt-2 text-sm text-white">
