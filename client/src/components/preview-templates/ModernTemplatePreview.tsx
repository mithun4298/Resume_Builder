...
export const ModernTemplatePreview = ({ resumeData }: { resumeData: any }) => {
  const getSectionTitleStyles = () => "text-lg font-semibold text-blue-600 mb-2 border-b-2 border-blue-500 pb-1";
  const getSkillTagStyles = () => "px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded";
  const getExperienceBorderStyles = () => "border-l-2 border-blue-200 pl-4";

  return (
    <div className="bg-gray-50 border border-blue-200 rounded-lg p-6 space-y-4 max-h-96 overflow-y-auto">
      <div className="text-center bg-blue-600 text-white p-4 rounded-t-lg -m-6 mb-4">
