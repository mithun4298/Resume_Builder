...
export const MinimalTemplatePreview = ({ resumeData }: { resumeData: any }) => {
  const getSectionTitleStyles = () => "text-sm font-semibold text-gray-700 mb-2 border-b border-gray-300 pb-1";
  const getSkillTagStyles = () => "px-2 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded";
  const getExperienceBorderStyles = () => "border-l border-gray-300 pl-4";

  return (
    <div className="bg-gray-50 border border-gray-100 rounded-lg p-6 space-y-4 max-h-96 overflow-y-auto">
